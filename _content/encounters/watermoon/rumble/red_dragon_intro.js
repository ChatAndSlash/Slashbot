...
const ENCOUNTER_NAME       = 'watermoon-rumble-red_dragon_intro';
const ACTION_CHALLENGE_THEM = 'challenge_them';

/**
 * Intro encounter for Red Dragon.
 */
class RedDragonEncounter extends Encounter {
  constructor() {
    super({
      type: ENCOUNTER_NAME,
      description: __("You enter the Warehouse, only to see the Red Dragon leaving.  Goons press in from all sides, one saying \"Nobody gets in to see da boss without goin' through us first.\""),
   ...
   */
  getImage(character) {
    return 'encounters/watermoon/red_dragon.png';
  }
...
module.exports = RedDragonEncounter;